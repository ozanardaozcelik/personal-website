...
<body>
  ...
  <nav class="site-nav" aria-label="Main Navigation">
    <a href="#story-section" class="nav-brand">OZAN ARDA</a>

    <!-- 3-PILL VIEW SELECTOR: 01 HİKAYEM / 02 YETENEKLERİM / 03 PROJELERİM -->
    <div class="nav-view-switcher" id="sectionNavSwitcher">
      <a href="#story-section" class="view-switch-pill is-active" id="btnNavStory" title="01 Hikayem (3D Eskiz Defteri)">
        <span class="view-switch-dot"></span>
        <span><span class="lang-tr">01 Hikayem</span><span class="lang-en">01 My Story</span></span>
      </a>
      <a href="#skills-section" class="view-switch-pill" id="btnNavSkills" title="02 Yeteneklerim (3D Kitaplık)">
        <span class="view-switch-dot"></span>
  ...
  <!-- =========================================================================
       01 HİKAYEM (3D INTERACTIVE SKETCHBOOK HERO)
       ========================================================================= -->
  <header class="story-hero-section" id="story-section">
    <iframe
      id="sketchbook-interactive-frame"
      class="story-interactive-frame"
    ...
    <a href="#dock-transition" class="story-scroll-cue" id="cueScrollToShelf" title="Raftaki Yerine Süzül">
      <span><span class="lang-tr">Aşağı Kaydırın · Kitap Kapanıyor &amp; Rafta Yerini Alıyor</span><span class="lang-en">Scroll Down · Book Closes &amp; Docks to Shelf</span></span>
  ...
  <!-- =========================================================================
       BOOK CLOSING & DOCKING INTERLUDE (01 HİKAYEM -> 02 YETENEKLERİM)
       ========================================================================= -->
  <section class="book-dock-interlude" id="dock-transition" aria-label="Book Docking Interlude">
    <div class="dock-sticky-stage">
      <div class="dock-editorial-cue">
        <div class="dock-phase-pill">
          <span>❖</span>
          <span><span class="lang-tr">GEÇİŞ EVRESİ // KİTAPLIK RAFINA YERLEŞİM</span><span class="lang-en">TRANSITION // DOCKING INTO SHELF</span></span>
        </div>
        <h2 class="dock-heading">
          <span class="lang-tr">Hikayem Kitabı Kapanıyor &amp; Yetenekler Rafına Yerleşiyor</span>
          <span class="lang-en">My Story Closes &amp; Docks Into the Shelf</span>
        </h2>
        <p class="dock-subtext">
          <span class="lang-tr">3 yaştan gökyüzüne uzanan dokunsal eskiz defteri kapaklarını örtüyor · Cilt 00 olarak raftaki yerini alıyor</span>
          <span class="lang-en">The tactile sketchbook folds shut · Taking its place on the shelf as Volume 00</span>
        </p>
      </div>

      <!-- 3D SCENE STAGE -->
      <div class="dock-3d-scene">
        <div class="dock-book-wrapper" id="dockBookWrapper">
          <!-- Spine (facing outward when rotated) -->
          <div class="dock-book-spine">
            <span>00</span>
            <span>HİKAYEM // OZAN ARDA</span>
            <span>❖</span>
          </div>

          <!-- Left Leaf / Front Cover -->
          <div class="dock-leaf left" id="dockLeafLeft">
            <div class="dock-leaf-face front-paper">
              <span class="dock-leaf-badge">LEVHA 01 // 1999</span>
              <div class="dock-leaf-art">
                <div class="dock-leaf-title">3 YAŞ: İLK BİLGİSAYAR</div>
                <div class="dock-leaf-sub">Retro Oyunlar · CRT Monitör · İlk Kıvılcım</div>
              </div>
              <span class="dock-leaf-badge">TEORİK BİLGİ ➔ PRATİK</span>
            </div>
            <div class="dock-leaf-face back-cover">
              <div class="cover-foil-box">
                <div class="cover-roman">0</div>
                <div>
                  <div class="cover-main-title">HİKAYEM</div>
                  <div class="cover-author">OZAN ARDA ÖZÇELİK</div>
                </div>
                <div class="cover-author">VOL. 00 // 9 DÖNÜM NOKTASI</div>
              </div>
            </div>
          </div>

          <!-- Right Leaf / Back Cover -->
          <div class="dock-leaf right" id="dockLeafRight">
            <div class="dock-leaf-face front-paper">
              <span class="dock-leaf-badge">LEVHA 09 // 2026</span>
              <div class="dock-leaf-art">
                <div class="dock-leaf-title">İNSAN FORMU — MAKİNE MANTIĞI</div>
                <div class="dock-leaf-sub">Şahi SİHA · Çözüm Makina · Gelecek Vizyonu</div>
              </div>
              <span class="dock-leaf-badge">SİHA YAZILIM LİDERİ</span>
            </div>
            <div class="dock-leaf-face back-cover">
              <div class="cover-foil-box">
                <div class="cover-roman">✦</div>
                <div class="cover-author">İNSAN FORMU // MAKİNE MANTIĞI</div>
              </div>
            </div>
          </div>
        </div>

        <!-- Shelf Target Receiver -->
        <div class="dock-shelf-receiver">
          <div class="shelf-books-row">
            <!-- DOCK TARGET SLOT FOR BOOK 00 -->
            <div class="shelf-dock-slot" id="shelfDockSlot">
              <span style="font-size:12px;">↓</span>
              <span><span class="lang-tr">CİLT 00 YUVASI</span><span class="lang-en">VOL 00 SLOT</span></span>
            </div>
            <!-- Neighboring Books Already on Shelf -->
            <div class="shelf-neighbor book-1"><span>I · GÖRÜ</span></div>
            <div class="shelf-neighbor book-2"><span>II · ROBOTİK</span></div>
            <div class="shelf-neighbor book-3"><span>III · YZ</span></div>
            <div class="shelf-neighbor book-4"><span>IV · DİLLER</span></div>
            <div class="shelf-neighbor book-5"><span>V · İLGİLER</span></div>
          </div>
          <div class="shelf-plank"></div>
        </div>
      </div>

      <!-- Docking Progress Telemetry -->
      <div class="dock-progress-wrapper">
        <span class="dock-progress-label">01 HİKAYEM</span>
        <div class="dock-progress-track">
          <div class="dock-progress-fill" id="dockProgressFill"></div>
        </div>
        <span class="dock-progress-label">02 YETENEKLERİM</span>
      </div>
    </div>
  </section>

  <!-- =========================================================================
       02 YETENEKLERİM (3D THREEUI SHELF LANDING PAGE)
       ========================================================================= -->
  <section class="skills-shelf-section" id="skills-section">
    <iframe
      id="shelf-interactive-frame"
      class="skills-shelf-frame"
    ...
    <div class="footer-middle-grid">
      <div>
        ...
        <ul class="footer-links">
          <li><a href="#story-section"><span class="lang-tr">01 Hikayem (Eskiz Defteri)</span><span class="lang-en">01 My Story (Sketchbook)</span></a></li>
          <li><a href="#skills-section"><span class="lang-tr">02 Yeteneklerim (Kitaplık)</span><span class="lang-en">02 Capabilities (Shelf)</span></a></li>
      ...
      <div>
        ...
        <ul class="footer-links">
          <li><span>VOL. 2026 // BUILD 4.2</span></li>
  ...
  <script>
    (function () {
      ...
      // 2. 3D Scroll-Driven Book Closing and Shelf Docking Animation
      const dockSection = document.getElementById('dock-transition');
      const dockBookWrapper = document.getElementById('dockBookWrapper');
      const dockLeafLeft = document.getElementById('dockLeafLeft');
      const dockLeafRight = document.getElementById('dockLeafRight');
      const shelfDockSlot = document.getElementById('shelfDockSlot');
      const dockProgressFill = document.getElementById('dockProgressFill');

      function updateBookDocking() {
        if (!dockSection || !dockBookWrapper) return;

        const rect = dockSection.getBoundingClientRect();
        const winH = window.innerHeight;
        const totalDistance = dockSection.offsetHeight - winH;

        if (totalDistance <= 0) return;

        // Progress from 0 (entry) to 1 (fully completed)
        let p = -rect.top / totalDistance;
        p = Math.max(0, Math.min(1, p));

        if (dockProgressFill) {
          dockProgressFill.style.width = (p * 100).toFixed(1) + '%';
        }

        // Phase 1 (0.00 -> 0.42): Folding the open sketchbook shut
        const foldProgress = Math.max(0, Math.min(1, p / 0.42));
        const leftDeg = foldProgress * 88; // 0 to 88 deg
        const rightDeg = -foldProgress * 88; // 0 to -88 deg

        if (dockLeafLeft) dockLeafLeft.style.transform = 'rotateY(' + leftDeg.toFixed(1) + 'deg)';
        if (dockLeafRight) dockLeafRight.style.transform = 'rotateY(' + rightDeg.toFixed(1) + 'deg)';

        // Phase 2 (0.42 -> 0.72): Tilting the shut book upright with spine facing front
        const tiltProgress = Math.max(0, Math.min(1, (p - 0.42) / 0.30));
        const rotY = tiltProgress * 90; // Rotate to face spine outward
        const rotZ = tiltProgress * 90; // Orient vertically
        const scale = 1 - tiltProgress * 0.15; // Slightly scale down to fit shelf slot

        // Phase 3 (0.72 -> 1.00): Gliding down and docking into the shelf slot
        const dockProgress = Math.max(0, Math.min(1, (p - 0.72) / 0.28));
        const translateY = (p * 40) + (dockProgress * 140); // Glide into receiver slot

        dockBookWrapper.style.transform = 
        ...
        if (shelfDockSlot) {
          shelfDockSlot.classList.toggle('is-docked', p >= 0.88);
        }
      }

      window.addEventListener('scroll', updateBookDocking, { passive: true });
      window.addEventListener('resize', updateBookDocking, { passive: true });
      updateBookDocking();

      // 3. Navigation Switcher Scroll-Spy & Active State Tracking
      ...
      function updateNavSpy() {
        ...
        const skillsTop = skillsSec ? skillsSec.offsetTop - winH * 0.4 : 999999;
...
console.log('Successfully written pristine index.html! Bytes:', html.length);
