...
const PAGES_TR=[
  {file:'marina-bay-sands.png',   title:'Şahi Otonom SİHA',                place:'TEKNOFEST Savaşan İHA — Hava Muharebesi & Güdüm'},
  {file:'gardens-by-the-bay.png', title:'Çözüm Makina Ar-Ge',             place:'Endüstriyel Bilgisayarlı Görü & Sıfır Hata Anomali'},
  {file:'merlion.png',            title:'Martur Fompak International',     place:'Kurumsal Çoklu Ajan (Agentic AI) Sistemleri'},
  {file:'buddha-tooth.png',       title:'Namık Kemal Üniversitesi',        place:'Bilgisayar Mühendisliği — Yüksek Onur Derecesi'},
  {file:'joo-chiat.png',          title:'Huawei Öğrenci Geliştiricileri',  place:'Yazılım Komitesi & Ekip Liderliği'},
  {file:'lau-pa-sat.png',         title:'İnsan Formu & Makine Mantığı',    place:'Gömülü Siber Form & Gerçek Zamanlı Yapay Zeka'},
  {file:'marina-bay-skyline.png', title:'Uçuş Kontrol & GNC Mimarisi',     place:'ArduPilot, PyMAVLink & SITL Simülasyonu'},
  {file:'singapore-river.png',    title:'Otonom Sürü & Koordinasyon',      place:'Hava Robotiği & Dağıtık Ajan Kararları'},
  {file:'botanic-gardens.png',    title:'Ar-Ge & Atölye Defteri',          place:'Saha Telemetrisi, Test Logları & Uçuş Notları'}
];

const PAGES_EN=[
  {file:'marina-bay-sands.png',   title:'Şahi Autonomous UAV',             place:'TEKNOFEST Fighting UAV — Combat Autonomy & Guidance'},
  {file:'gardens-by-the-bay.png', title:'Çözüm Makina R&D',                place:'Industrial Computer Vision & Zero-Defect Segmentation'},
  {file:'merlion.png',            title:'Martur Fompak International',     place:'Enterprise Multi-Agent (Agentic AI) Pipelines'},
  {file:'buddha-tooth.png',       title:'Namık Kemal University',          place:'Computer Engineering — High Honors Degree'},
  {file:'joo-chiat.png',          title:'Huawei Student Developers',       place:'Software Committee Lead & Engineering Mentorship'},
  {file:'lau-pa-sat.png',         title:'Human Form & Machine Logic',      place:'Embedded Cybernetic Form & Real-Time AI'},
  {file:'marina-bay-skyline.png', title:'Flight Guidance & GNC',           place:'ArduPilot, PyMAVLink & Hardware-in-the-Loop'},
  {file:'singapore-river.png',    title:'Autonomous Swarm Architecture',   place:'Aerial Robotics & Distributed Agent Coordination'},
  {file:'botanic-gardens.png',    title:'R&D & Field Notebook',            place:'Combat Telemetry, Hardware Logs & Flight Notes'}
];
