...
<body>
  ...
  <!-- =========================================================================
       ...
       - Layer 2: 3D Flutter Riffle (5-Leaf Cascading Riffle & Hardcover Snap Clap into Closed Leather Book)
    ...
    <div class="hero-sticky-viewport" id="heroStickyViewport">
      ...
      <div class="flow-layer flow-3d-book-layer" id="flow3dBookLayer">
        <div class="scroll-dock-book" id="scrollDockBook">
              ...
              <div class="sdb-paper">
                <div class="sdb-page-inner">
                  ...
                  <div class="sdb-body-content">
                    ...
                    <div class="sdb-sketch-sub">C++ &amp; Algoritmik Düşünce</div>
                    <p class="sdb-desc-text">
          ...
          <!-- FLUTTERING LEAF 4 (Turns P.08 -> P.09) -->
          <div class="sdb-leaf" id="sdbLeaf4">
            <div class="sdb-leaf-face front">
              <div class="sdb-paper">
                <div class="sdb-page-inner">
                  <div class="sdb-archival-header">
                    <span class="sdb-tag">LEVHA 08 // ROS 2 &amp; GAZEBO</span>
                    <span class="sdb-doc-num">DOC. 08/09</span>
                  </div>
                  <div class="sdb-body-content">
                    <div class="sdb-sketch-lead">3D Digital Twin</div>
                    <div class="sdb-sketch-sub">LiDAR Haritalama &amp; Otonom Navigasyon</div>
                    <p class="sdb-desc-text">
                      Fiziksel robotların 3D simülasyon ortamında test edilmesi ve otonom rota planlama algoritmalarının doğrulanması.
                    </p>
                  </div>
                  <div class="sdb-page-footer">
                    <span class="sdb-spec-pill">ROBOTİK SİMÜLASYON</span>
                    <span class="sdb-page-num">SAYFA 08</span>
                  </div>
                </div>
              </div>
            </div>
            <div class="sdb-leaf-face back">
              <div class="sdb-paper">
                <div class="sdb-page-inner">
                  <div class="sdb-archival-header">
                    <span class="sdb-tag">LEVHA 09 // SÜRÜ ZEKASI</span>
                    <span class="sdb-doc-num">DOC. 09/09</span>
                  </div>
                  <div class="sdb-body-content">
                    <div class="sdb-sketch-lead">Çoklu-İHA Formasyon</div>
                    <div class="sdb-sketch-sub">Dağıtık Karar Verme &amp; Mesh Ağlar</div>
                    <p class="sdb-desc-text">
                      Birden fazla otonom İHA'nın koordineli hedef paylaşımı ve dinamik hava formasyon algoritmaları.
                    </p>
                  </div>
                  <div class="sdb-page-footer">
                    <span class="sdb-spec-pill">SWARM ROBOTICS</span>
          ...
          <!-- FLUTTERING LEAF 5 (Turns P.10 -> P.11) -->
          <div class="sdb-leaf" id="sdbLeaf5">
            <div class="sdb-leaf-face front">
              <div class="sdb-paper">
                <div class="sdb-page-inner">
                  <div class="sdb-archival-header">
                    <span class="sdb-tag">LEVHA 10 // GÖMÜLÜ SİSTEMLER</span>
                    <span class="sdb-doc-num">DOC. 10/11</span>
                  </div>
                  <div class="sdb-body-content">
                    <div class="sdb-sketch-lead">NVIDIA Jetson &amp; ARM</div>
                    <div class="sdb-sketch-sub">Edge AI &amp; TensorRT Hızlandırma</div>
                    <p class="sdb-desc-text">
                      Kenar bilişim donanımlarında düşük güç tüketimiyle derin öğrenme modellerinin milisaniye seviyesinde çalıştırılması.
                    </p>
                  </div>
                  <div class="sdb-page-footer">
                    <span class="sdb-spec-pill">EDGE COMPUTING</span>
                    <span class="sdb-page-num">SAYFA 10</span>
                  </div>
                </div>
              </div>
            </div>
            <div class="sdb-leaf-face back">
              <div class="sdb-paper">
                <div class="sdb-page-inner">
                  <div class="sdb-archival-header">
                    <span class="sdb-tag">LEVHA 11 // GELECEK VİZYONU</span>
                    <span class="sdb-doc-num">DOC. 11/11</span>
                  </div>
                  <div class="sdb-body-content">
                    <div class="sdb-sketch-lead">İnsan Formu — Makine Mantığı</div>
                    <div class="sdb-sketch-sub">Geleceğin Otonom Dünyası</div>
                    <p class="sdb-desc-text">
                      Yapay zeka modellerini fiziksel robotik gövdelerle buluşturan, sıfır gecikmeli otonom sistemler vizyonu.
                    </p>
                  </div>
                  <div class="sdb-page-footer">
                    <span class="sdb-spec-pill">MANİFESTO 2026</span>
                    <span class="sdb-page-num">SAYFA 11</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <!-- HARDCOVER RIGHT WING (CLAPS SHUT FIRMLY OVER ALL PAGES) -->
          <div class="sdb-wing sdb-right" id="sdbWingRight">
            <div class="sdb-face sdb-paper">
              <div class="sdb-page-inner">
                <div class="sdb-archival-header">
                  <span class="sdb-tag">KİTAP SONU // ARŞİV MÜHRÜ</span>
                  <span class="sdb-doc-num">VOL. 00</span>
                </div>
                <div class="sdb-body-content">
                  <div class="sdb-sketch-lead">Cilt Tamamlandı</div>
                  <div class="sdb-sketch-sub">Ozan Arda Özçelik — 2008—2026</div>
                  <p class="sdb-desc-text">
                    Tüm levhalar ve araştırma notları tek bir deri cilt altında mühürlendi.
                  </p>
                </div>
                <div class="sdb-page-footer">
                  <span class="sdb-spec-pill">MÜHÜRLENDİ</span>
                  <span class="sdb-page-num">SON</span>
                </div>
              </div>
            </div>
  ...
  <script>
    (function () {
      ...
      // 2. Pure Scroll-Driven Continuous 3D Cascading Riffle & Hardcover Snap Clap:
      ...
      const leaf4 = document.getElementById('sdbLeaf4');
      const leaf5 = document.getElementById('sdbLeaf5');
      ...
      function onScrollHeroFlow() {
        ...
        // =========================================================================
        // 1. STAGE 1: 01 HİKAYEM (ORIGINAL 3D MENG-TO SKETCHBOOK) (p: 0.00 -> 0.32)
        // =========================================================================
        if (flowStoryLayer) {
          let storyOpacity = 1;
          if (p > 0.24 && p <= 0.32) {
            storyOpacity = Math.max(0, 1 - (p - 0.24) / 0.08);
          } else if (p > 0.32) {
            storyOpacity = 0;
          }

          flowStoryLayer.style.opacity = storyOpacity.toFixed(3);
          flowStoryLayer.style.visibility = p <= 0.32 ? 'visible' : 'hidden';
          flowStoryLayer.style.pointerEvents = (scrollY >= containerTop - 50 && p <= 0.24) ? 'auto' : 'none';
        }

        // =========================================================================
        // 2. STAGE 2: 5-LEAF CASCADING RIFFLE ("ŞAK ŞAK ŞAK") & HARDCOVER SNAP CLAP
        // =========================================================================
        if (flow3dBookLayer) {
          let book3dOpacity = 0;
          if (p < 0.24) {
          ...
          flow3dBookLayer.style.visibility = (p >= 0.24 && p <= 0.94) ? 'visible' : 'hidden';
        }

        if (p >= 0.24 && p <= 0.94 && scrollDockBook) {
          // Leaf 1: p in [0.32, 0.46]
          let l1 = 0;
          if (p >= 0.46) l1 = 1;
          else if (p > 0.32) l1 = smoothstep((p - 0.32) / 0.14);
          const curl1 = Math.sin(l1 * Math.PI) * 7;
          const lift1 = Math.sin(l1 * Math.PI) * 16;
          if (leaf1) {
            leaf1.style.transform = 'rotateY(' + (-l1 * 180).toFixed(2) + 'deg) rotateZ(' + (-curl1).toFixed(2) + 'deg) translateZ(' + lift1.toFixed(1) + 'px)';
            leaf1.style.zIndex = l1 < 0.5 ? 9 : 15;
          }

          // Leaf 2: p in [0.38, 0.52]
          let l2 = 0;
          if (p >= 0.52) l2 = 1;
          else if (p > 0.38) l2 = smoothstep((p - 0.38) / 0.14);
          const curl2 = Math.sin(l2 * Math.PI) * 6;
          const lift2 = Math.sin(l2 * Math.PI) * 14;
          if (leaf2) {
            leaf2.style.transform = 'rotateY(' + (-l2 * 180).toFixed(2) + 'deg) rotateZ(' + (-curl2).toFixed(2) + 'deg) translateZ(' + lift2.toFixed(1) + 'px)';
            leaf2.style.zIndex = l2 < 0.5 ? 8 : 16;
          }

          // Leaf 3: p in [0.44, 0.58]
          let l3 = 0;
          if (p >= 0.58) l3 = 1;
          else if (p > 0.44) l3 = smoothstep((p - 0.44) / 0.14);
          const curl3 = Math.sin(l3 * Math.PI) * 5;
          const lift3 = Math.sin(l3 * Math.PI) * 12;
          if (leaf3) {
            leaf3.style.transform = 'rotateY(' + (-l3 * 180).toFixed(2) + 'deg) rotateZ(' + (-curl3).toFixed(2) + 'deg) translateZ(' + lift3.toFixed(1) + 'px)';
            leaf3.style.zIndex = l3 < 0.5 ? 7 : 17;
          }

          // Leaf 4: p in [0.50, 0.64]
          let l4 = 0;
          if (p >= 0.64) l4 = 1;
          else if (p > 0.50) l4 = smoothstep((p - 0.50) / 0.14);
          const curl4 = Math.sin(l4 * Math.PI) * 4;
          const lift4 = Math.sin(l4 * Math.PI) * 10;
          if (leaf4) {
            leaf4.style.transform = 'rotateY(' + (-l4 * 180).toFixed(2) + 'deg) rotateZ(' + (-curl4).toFixed(2) + 'deg) translateZ(' + lift4.toFixed(1) + 'px)';
            leaf4.style.zIndex = l4 < 0.5 ? 6 : 18;
          }

          // Leaf 5: p in [0.56, 0.70]
          let l5 = 0;
          if (p >= 0.70) l5 = 1;
          else if (p > 0.56) l5 = smoothstep((p - 0.56) / 0.14);
          const curl5 = Math.sin(l5 * Math.PI) * 3;
          const lift5 = Math.sin(l5 * Math.PI) * 8;
          if (leaf5) {
            leaf5.style.transform = 'rotateY(' + (-l5 * 180).toFixed(2) + 'deg) rotateZ(' + (-curl5).toFixed(2) + 'deg) translateZ(' + lift5.toFixed(1) + 'px)';
            leaf5.style.zIndex = l5 < 0.5 ? 5 : 19;
          }

          // Hardcover Right Wing Clap Shut: p in [0.65, 0.80]
          let foldP = 0;
          if (p >= 0.80) foldP = 1;
          else if (p > 0.65) foldP = smoothstep((p - 0.65) / 0.15);
          const rightDeg = -foldP * 180;
          const coverLift = Math.sin(foldP * Math.PI) * 22;
          if (sdbWingRight) {
            sdbWingRight.style.transform = 'rotateY(' + rightDeg.toFixed(2) + 'deg) translateZ(' + coverLift.toFixed(1) + 'px)';
            sdbWingRight.style.zIndex = foldP > 0.5 ? 25 : 2;
          }

          // Docking into Shelf Slot 0: p in [0.80, 0.94]
          if (p <= 0.80) {
            ...
            let dockP = smoothstep((p - 0.80) / 0.14);
        ...
        // =========================================================================
        // 3. STAGE 3: 02 YETENEKLERİM (3D SHELF IFRAME) (p: 0.85 -> 1.00)
        // =========================================================================
        if (flowShelfLayer) {
          let shelfFade = 0;
          if (p > 0.85) {
            shelfFade = smoothstep((p - 0.85) / 0.09);
          }
          flowShelfLayer.style.opacity = shelfFade.toFixed(3);
          flowShelfLayer.style.visibility = p > 0.83 ? 'visible' : 'hidden';
        ...
        } else if (scrollY >= flowStart && p >= 0.85) {
      ...
      window.__scrollToSkills = function () {
        ...
        window.scrollTo({ top: top + travel * 0.90, behavior: 'smooth' });
      };
...
console.log('Successfully written complete 5-leaf cascading riffle and hardcover snap clap index.html! Bytes:', html.length);
