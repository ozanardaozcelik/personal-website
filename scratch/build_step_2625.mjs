...
<body>
  ...
  <!-- =========================================================================
       HERO SCROLL FLOW (01 HOME SPREAD -> 02 MILESTONES 3D TURNS -> 3D DOCK -> 03 SHELF)
       Entire home page IS Spread 0, zooms out in 3D to desk, turns 9 milestone pages,
       claps closed, and docks into slot 0 of the 3D shelf!
       ========================================================================= -->
  <div class="hero-scroll-flow" id="heroScrollFlow" style="height: 520vh;">
    <div class="hero-sticky-viewport" id="heroStickyViewport">
      ...
      <!-- LAYER 2: 3D UNIFIED PHYSICAL SKETCHBOOK WITH SPREAD 0 + 9 MILESTONES -->
      <div class="flow-layer flow-3d-book-layer" id="flow3dBookLayer">
        <div class="scroll-dock-book" id="scrollDockBook">
          ...
          <!-- SPREAD 0 LEFT: BASE WING (Hero Home Typography & Specs) -->
          <div class="sdb-wing sdb-left" id="sdbWingLeft">
            <div class="sdb-face sdb-hero-left-face">
              <div class="sdb-hero-left-inner">
                ...
                <h1 class="hero-home-title" style="font-size: clamp(2rem, 3.4vw, 3.2rem); margin: 0;">
                  <span>OZAN ARDA</span>
                  <span class="title-outline">ÖZÇELİK<em>.</em></span>
                </h1>

                <p class="hero-home-desc" style="margin: 0; font-size: clamp(0.78rem, 0.95vw, 0.88rem); line-height: 1.6;">
                ...
                <div class="hero-home-specs" style="gap: 8px;">
                  <div class="spec-card" style="padding: 6px 10px;">
                    <span class="spec-label" style="font-size: 0.62rem;"><span class="lang-tr">UNVAN</span><span class="lang-en">TITLE</span></span>
                    <span class="spec-val" style="font-size: 0.74rem;"><span class="lang-tr">Bilgisayar Mühendisi</span><span class="lang-en">Computer Engineer</span></span>
                  </div>
                  <div class="spec-card" style="padding: 6px 10px;">
                    <span class="spec-label" style="font-size: 0.62rem;"><span class="lang-tr">GÖREV</span><span class="lang-en">ROLE</span></span>
                    <span class="spec-val" style="font-size: 0.74rem;"><span class="lang-tr">Yazılım Ekip Lideri</span><span class="lang-en">Software Team Lead</span></span>
                  </div>
                  <div class="spec-card" style="padding: 6px 10px;">
                    <span class="spec-label" style="font-size: 0.62rem;"><span class="lang-tr">TAKIM</span><span class="lang-en">TEAM</span></span>
                    <span class="spec-val" style="font-size: 0.74rem;">Şahi SİHA (Teknofest)</span>
                  </div>
                </div>

                <div class="sdb-hero-scroll-prompt">
                  <span><span class="lang-tr">↓ Aşağı kaydırarak sayfaları çevirin (9 Levha)</span><span class="lang-en">↓ Scroll down to turn pages (9 Plates)</span></span>
                </div>
              </div>
            </div>

            <!-- Leather Back Cover (Visible when closed from behind) -->
          ...
          <!-- LEAF 0: Spread 0 Right (Hero Portrait Canvas) -> Spread 1 Left (Plate 01 Narrative) -->
          <div class="sdb-leaf" id="sdbLeaf0">
            <div class="sdb-leaf-face front sdb-hero-canvas-face">
              ...
              <div class="sdb-interactive-hint">
                <span class="lang-tr">✦ Portre üzerinde gezdirerek makine mantığını keşfedin</span>
                <span class="lang-en">✦ Hover over portrait to reveal robotic machine logic</span>
              </div>
            </div>
            <div class="sdb-leaf-face back">
              <div class="sdb-narrative-page">
          ...
          <!-- LEAF 1: Spread 1 Right (Plate 01 Art) -> Spread 2 Left (Plate 02 Narrative) -->
          ...
          <!-- LEAF 2: Spread 2 Right (Plate 02 Art) -> Spread 3 Left (Plate 03 Narrative) -->
          ...
          <!-- LEAF 3: Spread 3 Right (Plate 03 Art) -> Spread 4 Left (Plate 04 Narrative) -->
          ...
          <!-- LEAF 4: Spread 4 Right (Plate 04 Art) -> Spread 5 Left (Plate 05 Narrative) -->
          ...
          <!-- LEAF 5: Spread 5 Right (Plate 05 Art) -> Spread 6 Left (Plate 06 Narrative) -->
          ...
          <!-- LEAF 6: Spread 6 Right (Plate 06 Art) -> Spread 7 Left (Plate 07 Narrative) -->
          ...
          <!-- LEAF 7: Spread 7 Right (Plate 07 Art) -> Spread 8 Left (Plate 08 Narrative) -->
          ...
          <!-- LEAF 8: Spread 8 Right (Plate 08 Art) -> Spread 9 Left (Plate 09 Narrative) -->
          ...
          <div class="sdb-wing sdb-right" id="sdbWingRight">
            <div class="sdb-face sdb-art-page" style="padding: 12px; background: #fbf9f4;">
              <div class="sdb-art-container">
  ...
  <script>
    (function () {
      ...
      // Smart Deferred Hydration for 3D Bookshelf (Zero initial freeze)
      ...
      // Stagger background load for shelf
      ...
      // 2. Pure Scroll-Driven Continuous Timeline:
      // - Spread 0: Fullscreen Home Spread zooms out to desk
      // - 9 Sequential 3D Page Turns as scroll progresses
      // - Right Wing claps shut
      // - Closed book scales & docks into 3D Shelf
      ...
      function onScrollHeroFlow() {
        ...
        const inShelfRange = (scrollY >= flowTop + (flowH - winH) * 0.65) && (scrollY <= flowTop + flowH + 200);
        setShelfActiveState(inShelfRange);

        // Skip heavy style updates if scroll position is virtually unchanged
        if (Math.abs(p - lastP) < 0.0004 && Math.abs(scrollY - lastScrollY) < 1) return;
        lastP = p;
        lastScrollY = scrollY;

        // Dynamic start scale so Spread 0 covers the full screen when at scroll top (p = 0)
        const bookAspect = 1.6;
        const screenAspect = window.innerWidth / Math.max(1, window.innerHeight);
        let maxStartScale = 1.75;
        if (screenAspect > bookAspect) {
          maxStartScale = Math.min(2.4, (window.innerWidth / (Math.min(980, window.innerWidth * 0.94))) * 1.05);
        } else {
          maxStartScale = Math.min(2.4, (window.innerHeight / (Math.min(620, window.innerHeight * 0.80))) * 1.05);
        }

        // =========================================================================
        // 1. STAGE 1: SPREAD 0 MACRO ZOOM OUT (p: 0.00 -> 0.08)
        // =========================================================================
        if (p <= 0.08) {
          const zoomP = smoothstep(p / 0.08);
          const currentScale = maxStartScale - zoomP * (maxStartScale - 1.00);
          const rotateX = zoomP * 4.0;
          const shadowAlpha = 0.08 + zoomP * 0.18;
          const shadowY = 4 + zoomP * 28;
          const shadowBlur = 16 + zoomP * 48;
        ...
        // =========================================================================
        // 2. STAGE 2: 9 CHRONOLOGICAL 3D PAGE TURNS (p: 0.08 -> 0.62)
        // =========================================================================
        const turnStart = 0.08;
        const turnEnd = 0.62;
        const step = (turnEnd - turnStart) / 9; // ~0.06 per page
        ...
        // =========================================================================
        // 3. STAGE 3: HARDCOVER WING CLAP SHUT (p: 0.62 -> 0.70)
        // =========================================================================
        let foldP = 0;
        if (p >= 0.70) {
          foldP = 1;
        } else if (p > 0.62) {
          foldP = smoothstep((p - 0.62) / 0.08);
        }
        ...
        // =========================================================================
        // 4. STAGE 4: CLOSED 3D LEATHER BOOK DOCKS INTO 3D SHELF (p: 0.70 -> 0.88)
        // =========================================================================
        if (p > 0.08 && p <= 0.70) {
          scrollDockBook.style.transform =
            'translateY(0px) ' +
        ...
        // Book layer opacity fade after docking into shelf (p: 0.88 -> 0.94)
        if (flow3dBookLayer) {
          let bookFade = 1;
          if (p > 0.88) {
            bookFade = Math.max(0, 1 - (p - 0.88) / 0.06);
          }
          flow3dBookLayer.style.opacity = bookFade.toFixed(3);
          flow3dBookLayer.style.visibility = bookFade > 0 ? 'visible' : 'hidden';
          flow3dBookLayer.style.pointerEvents = p < 0.82 ? 'auto' : 'none';
        }

        // =========================================================================
        // 5. STAGE 5: 03 YETENEKLERİM (3D SHELF ON WHITE BACKGROUND) (p: 0.72 -> 1.00)
        // =========================================================================
        if (flowShelfLayer) {
          let shelfFade = 0;
          if (p > 0.70) {
            shelfFade = smoothstep((p - 0.70) / 0.18);
          }
          flowShelfLayer.style.opacity = shelfFade.toFixed(3);
          flowShelfLayer.style.visibility = p > 0.68 ? 'visible' : 'hidden';
      ...
      function scrollToStory() {
        if (flowContainer) {
          ...
          window.scrollTo({ top: totalTravel * 0.12, behavior: 'smooth' });
        }
      }
...
console.log('Successfully written complete 3D multi-page index.html! Bytes:', html.length);
