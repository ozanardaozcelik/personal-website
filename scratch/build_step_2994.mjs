...
<body>
  ...
  <div class="site-menu" id="site-menu-panel" aria-hidden="true">
    <ul class="menu-nav-list">
      ...
      <li class="menu-nav-item">
        <a href="#story" class="menu-nav-link" id="menu-link-story">
      ...
      <li class="menu-nav-item">
        <a href="#skills" class="menu-nav-link" id="menu-link-skills">
  ...
  <main class="main">
    ...
    <!-- [2] 02 HİKAYEM: 3D DOKUNSAL ESKİZ DEFTERİ (ORIGINAL 3D MENG-TO SKETCHBOOK) -->
    <section class="story-embed-section" id="story">
      <iframe
    ...
    <!-- [3] 03 YETENEKLERİM: 3D KİTAPLIK (ORIGINAL 3D WORKING VOLUMES SHELF) -->
    <section class="shelf-embed-section" id="skills">
      <iframe
  ...
  <script>
    (function () {
      ...
      // 2. Navigation & Active Section Tracking
      ...
      function updateNavHighlights() {
        ...
        const storyTop = getDocTop(storySec) - winH * 0.4;
        const skillsTop = getDocTop(skillsSec) - winH * 0.4;
        const projectsTop = getDocTop(projectsSec) - winH * 0.4;
        const contactTop = getDocTop(contactSec) - winH * 0.4;
      ...
      window.addEventListener('scroll', updateNavHighlights, { passive: true });
      updateNavHighlights();

      // Navigation Actions
      function scrollToHome() {
        if (heroSec) window.scrollTo({ top: 0, behavior: 'smooth' });
      }
      function scrollToStory() {
        if (storySec) window.scrollTo({ top: getDocTop(storySec) - 60, behavior: 'smooth' });
      }
      function scrollToShelf() {
        if (skillsSec) window.scrollTo({ top: getDocTop(skillsSec) - 60, behavior: 'smooth' });
      }
      function scrollToProjects() {
        if (projectsSec) window.scrollTo({ top: getDocTop(projectsSec) - 60, behavior: 'smooth' });
      }
      function scrollToContact() {
        if (contactSec) window.scrollTo({ top: getDocTop(contactSec) - 60, behavior: 'smooth' });
      }
...
console.log('Successfully written clean 5-section index.html! Bytes:', html.length);
