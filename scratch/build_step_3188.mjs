    ...
    (function () {
      ...
      function onScrollHeroFlow() {
        ...
        if (flowStoryLayer) {
          ...
          flowStoryLayer.style.pointerEvents = (scrollY >= containerTop - 50 && p <= 0.48) ? 'auto' : 'none';
        }
        ...
        } else if (scrollY >= flowStart && p >= 0.80) {
      ...
      window.__scrollToSkills = function () {
        ...
        window.scrollTo({ top: top + travel * 0.88, behavior: 'smooth' });
      };
...
console.log('Successfully written complete seamless index.html! Bytes:', html.length);
